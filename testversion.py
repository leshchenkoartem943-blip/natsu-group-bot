...
class SidebarApp:
    def __init__(self, root):
        ...
        create_databases_tab(self.frames["Databases"]) # <--- ДОБАВЛЕНО (Вызов новой функции)
        ...
        self._add_menu_btn("📂 Пробитые Базы", "Databases") # <--- ДОБАВЛЕНО (Кнопка в меню)
        self._add_menu_btn("⚙ Settings", "Settings")
        self._add_menu_btn("📝 Notes", "Notes")

        # Футер
        tk.Label(self.sidebar, text="v24.1 Pro", bg="#0F0F0F", fg="#555", font=("Consolas", 8)).pack(side="bottom", pady=10)
