...
def start_tapok_process():
    # Берем данные из базы сессий
    all_sessions = load_sessions()
    
    # Собираем всех выбранных мейкеров
    targets = []
    
    # selected_maker_phones - это множество (set) с номерами "7999..."
...
def create_dashboard_tab(parent):
    ...
    def on_tree_click(event):
        ...
        # ВАЖНО: Используем selected_maker_phones вместо current_maker_phone
